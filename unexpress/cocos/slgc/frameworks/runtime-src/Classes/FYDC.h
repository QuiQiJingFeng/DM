...
#define __REG_OBJ_FUNC(selector,target,cptype,key) FYDC::getInstance()->set(key,std::bind((FValue(cptype*)(FValueVector))(&selector),target,placeholders::_1));
#define REG_OBJ_FUNC(CLS,FUNC) __REG_OBJ_FUNC(CLS::FUNC,CLS::getInstance(),CLS::,#CLS"::"#FUNC)
